...
urlpatterns = [
    ...
    path('posts/<int:post_id>/comments/<int:comment_id>/edit/', views.CommentUpdateView.as_view(), name='edit_comment'),
    path('posts/<int:post_id>/comments/<int:comment_id>/delete/', views.CommentDeleteView.as_view(), name='delete_comment'),
]